...
class Menu: LTFHCViewController {
    ...
    override func viewDidLoad() {
        ...
        intake.titleLabel!.font = UIFont(name: "Helvetica", size: buttonFontHeight)
    ...
    func menuButtonPressed(sender: UIButton) {
        ...
        switch sender.titleLabel!.text!{
            ...
            case "Generate Report":
                self.navigationController?.pushViewController(PatientName(), animated: false) //Update to Generate Report
        default:
...
extension Menu {
    func buildConstraints(obj1: UIButton, obj2: UIButton, obj3: UIButton, spacer: UIView, spacer2: UIView, spacer3: UIView, spacer4: UIView){
        ...
        let register = obj2
        let report = obj3
        let spacerHeight: CGFloat = self.view.frame.height * 0.0825
        ...
        let spacer4Size = NSLayoutConstraint(item: spacer4, attribute: NSLayoutAttribute.Height, relatedBy: NSLayoutRelation.Equal, toItem: nil, attribute:NSLayoutAttribute.NotAnAttribute, multiplier: 1, constant: spacerHeight)
